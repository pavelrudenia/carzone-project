# Generated by Django 4.1 on 2022-09-23 07:00
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='car',
            name='state',
            field=models.CharField(choices=[('Mnk', 'Minsk'), ('Mg', 'Mogilew'), ('Gm', 'Gomel'), ('Vb', 'Vitebsk'), ('Gr', 'Grodno'), ('Br', 'Brest'), ('Ns', 'Nesvish'), ('Rg', 'Rogachev')], max_length=100),
        ),
    ]
